...
for video in video_paths:
    ...
    db = AkazeDB(video, registrant_video_path)
    db.filter_keypoints(3, 10)
    match_numbers_self = (db.check_matches(registrant_video_path, check_number=50, first_frame_number=50, mode='U-Net'))
    print(db.registrant)
    print(db.check_frequency(match_numbers_self))
